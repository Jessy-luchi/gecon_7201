...
(d) Commit and push the changes to your **econ_3201** repository on [GitHub.com](www.GitHub.com).
...
```{r}
#| eval: true
#| fig-cap: "City versus Highway Fuel Efficency (MPG)"
#| label: fig-2
